...
namespace UnityPackage.Editor
{
    public class PackageManifest : ScriptableObject
    {
        ...
        [SerializeField]
        private bool isUseDisplayNameAsRootFolderName;
        ...
        [SerializeField]
        private bool hasThirdPartyNotices;

        [SerializeField]
        private bool hasEditorFolder;

        [SerializeField]
        private bool hasRuntimeFolder;

        [SerializeField]
        private bool hasTestsFolder;

        [SerializeField]
        private bool hasTestsEditorFolder;

        [SerializeField]
        private bool hasTestsRuntimeFolder;

        [SerializeField]
        private bool hasDocumentationFolder;

        [SerializeField]
        private bool hasSamplesFolder;

        [SerializeField]
        private bool hasScreenshotsFolder;
        ...
        [SerializeField]
        private List<PackageKeyword> keywords;
        ...
        [SerializeField]
        private string thirdPartyNotices;
